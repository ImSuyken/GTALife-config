item_list = {
	...
	["GPS (scellé)"] = { w = 3, f = "scel", r = true},
	["Téléphone (scellé)"] = { w = 3, f = "scel", r = true },

	--["Téléphone"] = { w = 2, s = "apu", p = 25 },
	["Téléphone"] = { w = 1, s = "apu", p = 25, f = "tel", r = true },
	["Hamburger"] = { p = 4, f = "eat", v = 35, w = .5},
	["Eau de source"] = { p = 2, s = "apu", f = "dri", v = 20, w = .5},
	["Bière sans alcool"] = { p = 4, f = "dri", v = 35, w = .5},
	["Soda"] = { p = 3, f = "dri", v = 15, w = .5},
	["Café"] = { p = 10, f = "dri", v = 10, w = .5},
	["Chocolat"] = { p = 1, s = "apu", f = "eat", v = 15, w = .5},
	["Donut"] = { p = 2, f = "eat", v = 20, w = .5},
	["GPS"] = { p = 20, w = 1, s = "apu" },

	["Outil de crochetage"] = { p = 15, f = "lock", s = "qui", r = true, w = .5},

	["Trousse à outils"] = {p = 75, f = "repair", s = "dep", w = 2, r = true},
	["Kit de lavage"] = {p = 25, f = "wash", s = "dep", w = 1, r = true},
	["Trousse de soin"] = {p = 50, f = "heal", s = "med", w = 2},
	["Sac poubelle"] = {p = 26, w = 1, co = true},
	["Zip Ties"] = {p = 65, f = "zip", w = 1, r = true, s = "qui"},
	["Pinces"] = {p = 20, f = "zip", w = 2, r = true, s = "qui"},
	["Viande crue"] = {p = 8, f = "eat", v = 20},
	["GPS trafiqué"] = { p = 45, s = "qui", i = true, w = 1},
	...
	["Saumon cru"] = {},
	["Blé"] = {},
	["Pain"] = {p = 12, f = "eat", v = 45, co = true},
	["Uranium brut"] = {},
	["Uranium"] = {p = 9},
	["Raisin"] = {},
	["Vin"] = {p = 7, f = "dri", v = 10},

	["Cannabis"] = {p = 68, f = "smoke2", i = true},
	["Chanvre"] = {i = true},

	["Coca"] = {i = true},
	["Cocaïne"] = {f = "drug", i = true, p = 97},

	["Méthamphétamine"] = {p = 124, f = "drug", i = true},
	...
	["Cigarette"] = { p = 1, f = "smoke", s = "apu", co = true, w = .5},

	["Tortue dépecée"] = {p = 56, i = true, w = 2},
	...
	["Pistolet"] = {p = 4400, f = "wep", w = 4},
	["Pistolet de combat"] = {p = 5200, f = "wep", w = 4},
	["Pistolet cal.50"] = {p = 9000, f = "wep", w = 4},
	["Pétoire"] = {p = 3920, f = "wep", w = 4},
	["Pistolet lourd"] = {p = 8400, f = "wep", w = 4},
	["Pistolet vintage"] = {p = 7400, f = "wep", w = 4},
	["Pistolet de détresse"] = {p = 5500, f = "wep", w = 6},
	["Revolver"] = { p = 8800, f = "wep", w = 4 },

	["Pistolet mitrailleur"] = {p = 17940, f = "wep", w = 6},
	["TEC-9"] = {p = 15750, f = "wep", w = 6},
	-- wep ill
	["Matraque"] = {p = 173, f = "wep", w = 2},
	["Hachette"] = {p = 224, f = "wep", w = 3},
	["Machette"] = {p = 230, f = "wep", w = 3},
	["Dague"] = {p = 207, f = "wep", w = 2},
	["Mitraillette"] = {p = 18750, f = "wep", w = 6},
	["Musquet"] = {p = 7500, f = "wep", w = 6},
	["Mitraillette d'assaut"] = {p = 19500, f = "wep", w = 6},
	["ADP de combat"] = {p = 18266, f = "wep", w = 6},
	["Fusil d'assaut"] = {p = 21680, f = "wep", w = 8},
	["Carabine"] = {p = 23046, f = "wep", w = 8},

	["Grenade"] = {p = 8000, f = "wep", am = 5},
	["Bombe collante"] = {p = 9500, f = "wep", am = 5},
	["Coktail molotov"] = {p = 4500, f = "wep", am = 5},

	["Fusil à pompe"] = {p = 17700, f = "wep", w = 6},
	["Fusil à pompe bullpup"] = {p =19500, f = "wep", w = 8},
	["Fusil de précision"] = {p =41000, f = "wep", w = 10},
	["Fusil de précision lourd"] = {p = 52000, f = "wep", w = 10},
	["Feu d'artifice"] = {w = 4, f = "wep"},

	["Parachute"] = {p = 85, f = "wep", w = 2, s = "jetsam"},

	["Kevlar léger"] = { p = 500, w = 1, v = .33, f = "kev" },
	["Kevlar moyen"] = { p = 900, w = 2, v = .66, f = "kev" },
	["Kevlar lourd"] = { p = 1300, w = 3, v = 1, f = "kev" },

	["Boule de neige"] = {},
	["Balle de baseball"] = {p = 15, f = "wep", w = 1},
	["Fusil à impulsion"] = {f = "wep", w = 20},
	["Lance-missiles"] = {f = "wep", w = 20},
	["Lance-grenades compact"] = {f = "wep", w = 16},

	["Bombe artisanale"] = {p = 11000, f = "wep", am = 5},
	["Mine de proximité"] = {f = "wep", am = 5},

	["Fusil de précision à lunette"] = {p = 53000, f = "wep", w = 8},
	["Fusil à double canon"] = {p = 15000, f = "wep", w = 7},

	["Mitraillette légère"] = {p = 18400, f = "wep", w = 6},
	["Hache de guerre"] = {p = 142, f = "wep", w = 4},
	["Queue de billard"] = {p = 62, f = "wep", w = 1},
	["Clé anglaise"] = {p = 80, f = "wep", w = 2, s = "dep",},

	["Mitrailleuse"] = {p = 32000, f = "wep", w = 12},
	["Mitrailleuse de combat"] = {p = 38000, f = "wep", w = 13},
	["Sulfateuse Gusenberg"] = {p = 19730, f = "wep", w = 8},

	["Carabine spéciale"] = {p = 27596, f = "wep", w = 8},
	["Fusil amélioré"] = {p = 25200, f = "wep", w = 8},
	["Fusil bullpup"] = {p = 23800, f = "wep", w = 8},
	["Fusil compact"] = {p = 21200, f = "wep", w = 8},

	["Fusil à pompe d'assaut"] = {f = "wep", w = 7},
	["Fusil à pompe lourd"] = {p = 14350, f = "wep", w = 7},

	["Boîtier darknet"] = { p = 420, s = "qui", w = 1, f = "darknet", r = true},
	...
	["AC Lunette sniper avancée"] = { p = 1200, w = 0, f = "con", r = true},
	["AC Viseur SMG"] = { p = 350, w = 0, f = "con", r = true},
	["AC Viseur Assaut"] = { p = 425, w = 0, f = "con", r = true},
	["AC Viseur Combat"] = { p = 580, w = 0, f = "con", r = true},
	["AC Viseur Sniper"] = { p = 800, w = 0, f = "con", r = true},
	["AC Viseur SMG2"] = { p = 305, w = 0, f = "con", r = true},
	["AC Viseur MG"] = { p = 250, w = 0, f = "con", r = true},
	["AC Poignée"] = { p = 390, w = 0, f = "con", r = true},
	["AC Silencieux (Pistolets)"] = { p = 450, w = 0, f = "con", r = true},
	["AC Silencieux (Assaut)"] = { p = 1200, w = 0, f = "con", r = true},
	["AC Silencieux (SMG/Pompes/Sniper)"] = { p = 1500, w = 0, f = "con", r = true},
	["AC Silencieux (Pistolets puissants)"] = { p = 500, w = 0, f = "con", r = true},
	["AC Silencieux (Fusil à pompe)"] = { p = 1400, w = 0, f = "con", r = true},
