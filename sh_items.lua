item_list = {
	...
	["Hamburger"] = { p = 4, f = "eat", v = 23, w = .5},
	["Eau de source"] = { p = 2, s = "apu", f = "dri", v = 20, w = .5},
	["Bière sans alcool"] = { p = 4, f = "dri", v = 30, w = .5},
	...
	["Chips"] = { p = 2, s = "apu", f = "eat", v = 25, w = .5},
	["Hot-dog"] = { p = 3, s = "apu", f = "eat", v = 30, w = .5},
	...
	["Coca"] = {i = true},
	["Cocaïne"] = {f = "drug", i = true, p = 93},

	["Méthamphétamine"] = {p = 116, f = "drug", i = true},
	...
	["Kevlar lourd"] = { p = 1400, w = 3, v = 1, f = "kev" },
